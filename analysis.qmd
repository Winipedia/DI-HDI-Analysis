...
## Some notes
- Using landscape mode for the PDF output because some plots and model summaries are too wide for the default portrait mode and get cut off at the right side. 
