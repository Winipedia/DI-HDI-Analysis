...
In this specific model we had a convergence warning where the standard numerical method did not converge but instead the lbfgs method was used instead. This is not of serious concern but should be noted here. 
...
Perhaps democracy has only such a slight effect that it can only be seen with more longterm data. 
